...
import expecto_patronum.IList;
import expecto_patronum.List;
...
public class Main {
		...
		public static void main (String[] args) {
			...
			for (int i = 0; i < 100000000; i++) lista.append("teste");
			long endMillis = System.currentTimeMillis();

			System.out.println(lista.count() == 100000000);

			// benchmark: anotar o desempenho e tentar melhorá-lo (qto menos tempo melhor)
